...
<head>
    ...
    <meta name="title" content="Homepage MINI POS">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <h1 class="fw-bolder">Mini POS</h1>
                        <h2 class="lead fw-normal text-muted mb-5">Point Of Sales for your business</h2>
                        <!-- Button Modal -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card bg-white shadow-soft text-primary rounded mb-4">
                            <div class="px-3 px-lg-4 py-5 text-center">
                                <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                    data-icon="sass" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 640 512">
                                    <path fill="currentColor"
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card bg-white shadow-soft text-primary rounded mb-4">
                            <div class="px-3 px-lg-4 py-5 text-center">
                                <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                                    data-icon="html5" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 384 512">
                                    <path fill="currentColor"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <h2 class="h1 fw-bold mb-3">View Products</h2>
                    </div>
                </div>
                <div class="row mt-6">
                    <div class="col-12 col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="card shadow border-0 p-4">
                            <img src="{{asset('images/standard_repo.png')}}" class="card-img-top" alt="...">
                            <!-- Header -->
                            <div class="card-header bg-white border-0 pb-0">
                                <span class="d-block">
                                    <span class="h2 text-primary fw-bold align-top">Majo Pro</span>
                                </span>
                                <p>Rp. 2.750.000</p>
                            </div>
                            <!-- End Header -->
                            <!-- Content -->
                            <div class="card-body">
                                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. In inventore officia velit explicabo vel quisquam iure? Labore, facere ipsa molestiae non delectus, cum, facilis reiciendis ullam modi deserunt voluptate assumenda?</p>
                            </div>
                            <a href="#" target="_blank"
                            class="btn btn-secondary d-flex align-items-center justify-content-center mb-0 mt-2">Beli</a>
                            <!-- End Content -->
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="card shadow border-0 p-4">
                            ...
                            <div class="card-header bg-white border-0 pb-0">
                                <span class="d-block">
                                    <span class="h2 text-primary fw-bold align-top">Majo Advance</span>
                                </span>
                                <p>Rp. 3.000.000</p>
                            </div>
                            <!-- End Header -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="card shadow border-0 p-4">
                            <img src="{{asset('images/paket-lifestyle.png')}}" class="card-img-top" alt="...">
                            <!-- Header -->
                            <div class="card-header bg-white border-0 pb-0">
                                <span class="d-block">
                                    <span class="h2 text-primary fw-bold align-top">Majo Lifestyle</span>
                                </span>
                                <p>Rp. 4.000.000</p>
                            </div>
                            <!-- End Header -->
                    ...
                    <div class="col-12 col-md-6 col-lg-3 mb-5 mb-lg-0">
                        <div class="card shadow border-0 p-4">
                            <img src="{{asset('images/paket-desktop.png')}}" class="card-img-top" alt="...">
                            <!-- Header -->
                            <div class="card-header bg-white border-0 pb-0">
                                <span class="d-block">
                                    <span class="h2 text-primary fw-bold align-top">Majo Desktop</span>
                                </span>
                                <p>Rp. 5.000.000</p>
                            </div>
                            <!-- End Header -->
    ...
    <footer class="footer py-6 bg-gray-800 text-white">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h3>Mini POS</h3>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium esse, totam possimus atque
                        consequuntur cumque voluptatibus. Adipisci amet, perferendis dicta eos maiores distinctio fugiat
                        maxime dolor? Earum vel adipisci laborum!</p>
                </div>
                <div class="col-6 col-md-2 mb-5 mb-lg-0">
                    <span class="h5">Mini POS</span>
            ...
            <div class="row">
                <div class="col mb-md-0">
                    ...
                    <div class="d-flex text-center justify-content-center align-items-center" role="contentinfo">
                        <p class="fw-normal font-small mb-0">Copyright © Minipos <span class="current-year">2021</span>.
